...
import { Users, Calendar, Car, Phone, Mail, MapPin } from "lucide-react";
      ...
      <main className="min-h-screen bg-slate-100 p-8">
        ...
        <div className="mb-10 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h2 className="mt-2 text-4xl font-bold">{leads.length}</h2>
              </div>
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-500">Today&apos;s Leads</p>

                <h2 className="mt-2 text-4xl font-bold">{todayLeads.length}</h2>
              </div>
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h2 className="mt-2 text-4xl font-bold">{thisMonth.length}</h2>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <h2 className="mt-2 text-xl font-semibold truncate max-w-[150px]">
                  {latestLead ? latestLead.firstName : "--"}
                </h2>
              </div>
                  ...
                  >
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium">{lead.zipCode}</span>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-5">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-slate-500">{lead.model}</p>
                      </div>
                    </td>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white px-6 py-5 md:flex-row">
          <div>
            <h3 className="font-semibold text-slate-800">ShieldDrive Admin</h3>
